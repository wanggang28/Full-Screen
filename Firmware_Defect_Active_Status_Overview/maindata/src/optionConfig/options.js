...
import $ from 'jquery'
var data_table={
    name:['Release','Phase','Next Milestone','Details'],
    data:[
        {release:['Purley MLK','Mehlow','A2','A2 MLK','18D Block']},
        {phase:['SDV','BBFV','SIT','BBFV','BBFV']},
        {'Next Milestone':['SDV Exit 08/24/2018','SDV Exit 08/24/2018','SDV Exit 08/24/2018','SDV Exit 08/24/2018','SDV Exit 08/24/2018']},
        {Details:['O/W/R: 4 (6). 3','O/W/R: 4 (6). 3','O/W/R: 4 (6). 3','O/W/R: 4 (6). 3','O/W/R: 4 (6). 3']}
    ]
}
...
var data = {
    title: ['总计', '12-01', '12-02', '12-03'],
    plan_production: [500, 300, 490, 333],
    actual_production: [300, 400, 500, 300],
    attainment_rate: [60, 80, 90, 60],
    productivity: [30, 45, 88, 100]
};
